...
const BROKEN_ON_PRODUCTION = new Set([
  // The theme's custom CSS paints the opt-in popup with a background image whose
  // URL was pasted over itself — `…/47122-1.jpg` followed by a second copy of the
  // path minus its first segment. It 404s on WordPress, so that popup has never
  // had its background there either.
  '/wp-content/uploads/2024/03/47122-1.jpgcontent/uploads/2024/03/47122-1.jpg',
]);
